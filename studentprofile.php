<?php
    ...
    if(!$_SESSION['user_id']) {
		...
		$info = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM users WHERE user_id=$sid"));
	}
?>
	...
	<div class="container">
		<div class="content-wrapper">
			<div class="content">
                ...
                ?>
				<h1 style="padding-left:50px; padding-top:20px">
					<?php echo $name; ?>
				</h1>
                ...
                <?php
                    if(empty($info['adviser_id'])) {
                        $msg = "N/A";
                    } else {
                        $data = mysqli_fetch_assoc(mysqli_query($connect, "SELECT first_name, last_name FROM users WHERE user_id=".$info['adviser_id']));
                        $msg = $data['name'];
                    }
